...
class triangle : public hittable {
  public:
    ...
    bool hit(const ray& r, interval ray_t, hit_record& rec) const override {
      ...
      //When ray is very close to or parallel to the plane
      ...
      // Check if incident point is inside the quad
      ...
      // Ray hitting the plane
      rec.t              = t;
      rec.point_incident = intersection;
      rec.material       = mat;
